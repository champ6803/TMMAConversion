app.controller("assignMaterialToRoutingController", function ($scope, $http) {
    $scope.AssignMaterialToRoutingFileViewModel = typeof AssignMaterialToRoutingFileViewModel !== "undefined" ? AssignMaterialToRoutingFileViewModel ? AssignMaterialToRoutingFileViewModel : {} : {};
    $scope.User = "";
    $scope.File = "";
    $scope.Files = "";
    $scope.RecObjectName = "";
    $scope.AssignMaterialToRoutingFileID = null;
