app.controller("routingWithMaterialController", function ($scope, $http) {
    $scope.RoutingWithMaterialFileViewModel = typeof RoutingWithMaterialFileViewModel !== "undefined" ? RoutingWithMaterialFileViewModel ? RoutingWithMaterialFileViewModel : {} : {};
    $scope.User = "";
    $scope.File = "";
    $scope.Files = "";
    $scope.RecObjectName = "";
    $scope.RoutingWithMaterialFileID = null;
